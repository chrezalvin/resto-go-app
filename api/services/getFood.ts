import { Branch, Food, isFood, isTransaction, Transaction } from "../models";
...
export async function getFoodByBranch(branch_id: Branch["branch_id"]): Promise<Food[]>{
...
export async function getFoodByTransaction(branch_id: Branch["branch_id"]){
...
export async function getCustomerInBranch(branch_id: Branch["branch_id"]): Promise<CustomerInBranchResponse[]>{
